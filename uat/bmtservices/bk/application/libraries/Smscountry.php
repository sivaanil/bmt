...
class Smscountry 
{
	private $user="tayatech"; //your username
	private $password="T@ya@123"; //your password
	private $senderid="IDSTHQ"; //Your senderid
	...
	public function sendSms($sms)
	{
		//print_r($sms);exit;
			...
			$url="http://bulksms.tayagroup.com/WebServiceSMS.aspx";
