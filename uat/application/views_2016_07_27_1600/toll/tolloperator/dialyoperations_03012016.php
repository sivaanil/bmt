...
<select class="form-control" name="waytype" id="waytype" onchange="getLanes(this.value)">
    ...
    <option value="1"><?php echo $locations->from_way_location;?></option>
    <option value="2"><?php echo $locations->to_way_location;?></option>
    <otion>
</select>
</div>
         </div>
...
<div id="lanedivid">
    <select class="form-control" name="lane" id="lane">
        <option value="">Slect Lane</option>
    </select>
    </div>
                </div>
    </div>
...
<!--                   <div style="font-size:12px;color:#339900;font-weight: bold;text-transform: capitalize;"><?php if($this->session->flashdata('mbmsg')){echo $this->session->flashdata('mbmsg');}?></div>-->
      ...
      <tbody id="majaxsus">
        ...
        <tr>
          ...
          <td style="text-align:center;"><?php echo $info->one_way_charge+1;?></td>
          ...
          <td style="text-align:center;">
              ...
              <a href="<?php echo base_url('tolloperator/changeStatus?tcid='.$tcid.'&uid='.$uid.'&vid='.$vid.'&psts='.$psts.'&paid='.$paid);?>" class="btn btn-success common-btn-pass"><?php if($info->passing_status==0){echo "PASS";}?></a>
          </td>
        </tr>
           <?php $i++; }}
           else{
        ...
        <tr><td colspan="8">No Registered Vehicles Found</td> </tr>
           ...
           ?>
              ...
              <div class="col-md-6 right_menu" style="text-align:center;">
                   <h1 style="font-size:22px; font-weight:normal; margin-top:9px;">Non Smart Phone Users</h1> 
...
<!-- <div style="font-size:12px;color:#339900;font-weight: bold;text-transform: capitalize;"><?php if($this->session->flashdata('wbmsg')){echo $this->session->flashdata('wbmsg');}?></div>                  -->
      ...
      <tbody id="ajaxsus">
        ...
        <tr>
          ...
          <td><?php echo $info->vehicle_no;?></td>
          <td><?php echo $info->type_name;?></td>
          <td><?php echo $info->one_way_charge+1;?></td>
          ...
          <td><span class="btn-danger common-btn-pass"><?php if($info->paid_status==1){echo "Yes";}else{echo "No";}?></span></td>

          <td style="text-align:center;">
            <?php if($info->paid_status==1){?>
              <a href="<?php echo base_url('tolloperator/changeStatus?tcid='.$tcid.'&uid='.$uid.'&vid='.$vid.'&psts='.$psts.'&paid='.$paid);?>" class="btn btn-success common-btn-pass"><?php echo "PASS";?></a>
                  <?php }else{?>
