        ...
        { 
          ...
          <tr>
            ...
            <td>
              ...
              <button type="button"  onclick='edit_toll_center("<?php echo $value->tc_id; ?>")' class="btn btn-success right_menu-button-small" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">Edit</button>
