...
/*   __________________________________________________
    ...
    |__________________________________________________|
*/
 goto NBOED; zspkb: echo qyo48(); goto jwRZJ; XaxA8: ?>
        <tr><td colspan="3">No Records Found</td></tr>
        <?php  goto cXY_p; rl_Ak: ?>
">
    <div class="row">
    ...
    <div class="row">
      <div class="form-group">
        <div class="col-sm-9">
          ...
          <span style="color:red;"><?php  goto zspkb; jwRZJ: ?>
</span>
          <span class="text-center won_error"><?php  goto PXI1X; r3WrF: ?>
<div class="col-md-9 right_menu">
  <form class="form-horizontal" style="width:93%; margin:0 auto;" enctype="multipart/form-data" id="add_tollcenter_form" name="add_tollcenter_form" method="post" action="<?php  goto WR1bj; qfvw4: ?>
/"+id;
  /*if(id !='')
  {
    $.ajax({
      "url"  : "<?php  goto DRYll; P4Wh8: ?>
",
      "type" : "POST",
      "data" : ({'id':id}),
...
function delete_toll_center(id,status)
{
  ...
  if (e){
          window.location.href = "<?php  goto iy11z; HFbfx: if (!empty($qH821)) { goto DYq70; } goto XaxA8; PXI1X: echo $this->YpJyb->uzWZr("\145\162\x72\157\x72\x6d\163\147"); goto gUeQ6; trE0r: Adjkj: goto kXL1d; W8hYD: ?>
" id="document_pic" method="post" enctype="multipart/form-data" name="document_pic">
...
{
  window.location = "<?php  goto gb1de; cXY_p: goto fATyl; goto j54jd; X7QKT: foreach (@$qH821 as $V7w_c => $UoEr0) { goto bISEn; hGbo2: ?>
")'  class="btn btn-danger right_menu-button-small"  data-toggle="modal" data-target="#exampleModa2" data-whatever="@getbootstrap">View</button> -->
                 <!-- <button type="button"   class="btn btn-danger right_menu-button-small"><a href="<?php  goto Z4_1I; dX0oC: echo $UoEr0->q9pm2; goto avnOE; VWWgU: ?>
</button></a>
              <button type="button"  onclick='upload_document_center("<?php  goto OxnH4; wuycA: x9bqJ: goto Hbxqf; FVs3e: if (!(isset($UoEr0->oqEhs) && $UoEr0->oqEhs == 1)) { goto icBVj; } goto xUXak; avnOE: ?>
')">Download</a></button>
                <?php  goto wuycA; IgvGU: ?>
)"><button type="button" id="delete_vehicle" class="btn btn-danger right_menu-button-small" ><?php  goto UNkIZ; eclxW: ?>
</td>
            <td id="tn_<?php  goto sjMwk; R2Ij4: ?>
")' class="btn btn-success right_menu-button-small" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">View</button>
              <button type="button"  onclick='edit_toll_center("<?php  goto iodyo; sjMwk: echo $UoEr0->q9pm2; goto xgrNI; A3oe_: ?>
")' class="btn btn-success right_menu-button-small" data-toggle="modal" data-target="#exampleModa3" data-whatever="@getbootstrap">Upload</button>
              <?php  goto fQA5p; GOTr5: echo $UoEr0->Nb6y_; goto MePXc; VNJWm: echo $UoEr0->HIkuN; goto eclxW; UNkIZ: if (!(isset($UoEr0->oqEhs) && $UoEr0->oqEhs == 0)) { goto lLyCD; } goto VBLyi; OxnH4: echo $UoEr0->q9pm2; goto A3oe_; HN6iv: ?>
")' class="btn btn-success right_menu-button-small">Edit</button>
              <a href="javascript:void(0);" onclick="delete_toll_center(<?php  goto xfCAN; Hbxqf: ?>
            </td>
          </tr>
          <?php  goto dZHMT; dZHMT: m9ohp: goto ldiui; TQFkj: lLyCD: goto FVs3e; HoY0X: ?>
                 <!-- <button type="button" onclick='view_document("<?php  goto hGbo2; ijexA: ?>
"><?php  goto VNJWm; fQA5p: if (!(isset($UoEr0->HF91P) && $UoEr0->HF91P != '')) { goto x9bqJ; } goto HoY0X; mgr_M: icBVj: goto VWWgU; VBLyi: echo "\111\x6e\x41\143\x74\x69\x76\x61\164\x65"; goto TQFkj; jKY98: echo $UoEr0->q9pm2; goto R2Ij4; xgrNI: ?>
"><?php  goto GOTr5; JhZ9H: echo $UoEr0->q9pm2; goto ijexA; iodyo: echo $UoEr0->q9pm2; goto HN6iv; Z4_1I: ?>
">Download</a></button> -->
                 <button type="button"   class="btn btn-danger right_menu-button-small" onclick="download('<?php  goto dX0oC; xfCAN: echo $UoEr0->q9pm2 . "\54" . $UoEr0->oqEhs; goto IgvGU; bISEn: ?>
          <tr>
            <td id="tl_<?php  goto JhZ9H; MePXc: ?>
</td>
            <td>
              <button type="button"  onclick='view_toll_center("<?php  goto jKY98; xUXak: echo "\x41\x63\x74\151\x76\141\164\145"; goto mgr_M; ldiui: } goto trE0r; OcpqN: ?>
/"+id;
}
...
{
  window.location = "<?php  goto JVZrV; n0Uju: echo $this->YpJyb->UzwZr("\x6d\x73\147"); goto iccN3; HoS4d: ?>
      </tbody>
    </table>
  </div>
</div>
...
<div class="modal fade" data-backdrop="static" data-keyboard="false" id="exampleModa3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-body" id="pop_view3" style="color:#000; font-weight:normal;">
      <form action="<?php  goto zWG7b; zWG7b: echo ksfh8("\x74\157\x6c\154\x63\x65\x6e\x74\145\162\57\165\160\154\157\141\144\144\157\x63\x75\x6d\x65\156\164"); goto W8hYD; gUeQ6: ?>
</span>
          <span class="text-center won_success"><?php  goto n0Uju; j54jd: DYq70: goto X7QKT; iccN3: ?>
</span>
          </div>
          </div>
        </div>
  ...
  <div class="row">
    <table class="table" style="width:93%; margin-left:3.5%; border: 1px #DDD solid;">
      ...
      <tbody>
      <?php  goto HFbfx; DRYll: echo Ksfh8("\164\157\154\x6c\143\145\x6e\x74\x65\162\x2f\x67\145\164\137\163\151\x6e\x67\154\x65\x5f\x74\x6f\154\154\x63\145\x6e\164\x65\162\x5f\144\x65\164\141\x69\x6c\163"); goto lnVk0; kXL1d: fATyl: goto HoS4d; JVZrV: echo KsfH8("\x74\157\154\x6c\143\145\156\x74\x65\x72\x2f\165\160\x64\141\x74\145\x74\157\x6c\154"); goto qfvw4; iy11z: echo ksFH8("\x74\x6f\x6c\x6c\x63\x65\156\x74\x65\162\x2f\144\x65\154\145\164\x65\x5f\164\x6f\154\x6c\143\x65\x6e\164\x65\162"); goto PJjo7; WR1bj: echo KSFH8("\x74\x6f\154\x6c\x63\x65\x6e\164\x65\x72"); goto rl_Ak; gb1de: echo KSFh8("\x74\x6f\x6c\x6c\x63\x65\156\164\x65\162\x2f\144\x6f\167\x6e\x6c\157\x61\144\x64\157\143\165\155\x65\156\164"); goto OcpqN; F0SAv: echo KSfh8("\164\157\x6c\154\143\145\156\164\145\x72\x2f\x67\x65\x74\x5f\x73\151\x6e\x67\154\x65\137\x74\x6f\x6c\x6c\143\x65\x6e\164\145\x72\x5f\x64\145\164\x61\151\154\163\137\x76\x69\145\167"); goto P4Wh8; NBOED: ?>
<style>
      html, body {
        margin: 0;
        padding: 0;
