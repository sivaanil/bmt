        ...
        <div class="row">
            <div class="col-md-8 col-sm-8">
                <div class="post-heading">
                    ...
                    <h1 style="color: #000000;" class="subheading">BOOK MY TOLL</h1>
                    
                </div>
            </div>
            <div class="col-md-4 col-sm-4">
            <form id="contactForm" method="post" action="<?php echo base_url('toll/login')?>" name="userlogin" class="toll-login">
                <h1>LOGIN</h1>
                ...
                <div class="row control-group common-form">
                <span style="padding-right: 6%;" class="pull-right"><a href="<?php echo base_url('toll/fogetpassword')?>" style="color:#ffa800 !important;">FORGOT PASSWORD ?</a></span>
                </div>
                <div class="row">
                ...
                <div class="text-center" style="color:red;text-align:center; font-size: 13px;"><?php echo $this->session->flashdata('msg');?></div>
                <div class="text-center" style="color:green;text-align:center;font-size: 13px;"><?php echo $this->session->flashdata('msgsuccess');?></div>
            </form>
            </div>
        </div>
    </div>
