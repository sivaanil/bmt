                ...
                <div class="form-group col-xs-12 floating-label-form-group controls">
                    ...
                    <select class="form-control" name="waytype" id="waytype" onchange="getLanes(this.value)">
                        ...
                        <?php }else{ ?>
                            ...
                            <option value="3"><?php echo $locations->orr_from_way_location; ?></option>
                            <option value="4"><?php echo $locations->orr_to_way_location; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>
