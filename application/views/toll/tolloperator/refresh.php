...
<div class="row">
    ...
    if (isset($isUpdated) && $isUpdated == 1) {
        ?>
        <div class="col-md-12" id="updatedMsg" style="text-align:center;color:green;style:display:none">Toll Center Updated, Your account will logout in 5 Sec.Please Login Again</div>
    <?php } ?>
    ...
    $(document).ready(function () {
        ...
        if (isUpdated == 1) {
            ...
            setInterval(function () {
                ...
                //~ async: false,
                //~ crossDomain: true,
                //~ url: 'http://uat.bookmytoll.com/tolloperator/refresh'
                //~ 
                //~ });
                $(location).attr('href', '<?php echo base_url('toll/logout'); ?>')
            }, 5000);
        }
