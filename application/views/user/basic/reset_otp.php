    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4">
                <form id="contactForm" method="post" action="<?php echo base_url('user/resetpasswordbyotp?mobile='.$_GET['mobile'])?>" name="userlogin" class="toll-login">
              ...
              <?php }?>
                <div class="form-group col-xs-12" style="color:green">
