...
<div class="row">
    ...
    if (isset($isUpdated) && $isUpdated == 1) {
        ?>
        <div class="col-md-12" id="updatedMsg" style="text-align:center;color:green;style:display:none">Toll Center Updated, Your account will logout in 10 Sec.Please Login Again</div>
    <?php } ?>
