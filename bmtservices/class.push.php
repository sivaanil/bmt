...
class pushmessage{ 
	...
	public $iosApnsCert			= '/var/www/html/bmtservices/PushNotificationAppCertificateKey.pem';
	...
	//	$ssl_url				= 'ssl://gateway.push.apple.com:2195'; 
        ...
        stream_context_set_option($streamContext, 'ssl', 'local_cert', 'PushNotificationAppCertificateKey.pem'); 
